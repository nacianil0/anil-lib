...
title anil-lib-reader - Dev Durdur
...
goto :parse
:run
powershell -NoProfile -ExecutionPolicy Bypass -File "%TOOLS_DIR%\lib\Stop-Dev.ps1" %PASSTHRU%
set "COMMAND_EXIT=%ERRORLEVEL%"
if not "%COMMAND_EXIT%"=="0" echo [HATA] Dev durdurma basarisiz. Exit code: %COMMAND_EXIT%
