...
revision_note: "Çatı çizgisi sezgi, formül ve gerçek sayılarla yeniden kuruldu; tersine yazılmış ilişki düzeltildi, iki şekil ölçekli grafiğe çevrildi."
---
...
Yatay eksen **işlem yoğunluğu**: bir hesabın, ana bellekten okuduğu her bayt için yaptığı işlem sayısı. Dikey eksen ulaşılabilir hız. Modelin sezgisi tek cümle: bir hesap iki şeyi bekler — çarpılacak sayıların bellekten gelmesini ve çarpmanın kendisini — ve bu iki iş üst üste bindirilebildiğinde süre, ikisinden uzun olanı kadardır. Modelin varsayımı da buradan: veri çipin içindeki önbelleğe sığmıyor, yani her bayt ana bellekten gelmek zorunda.

Sözle kuralım. Taşıma süresi, taşınan bayt bölü bant genişliğidir; hesap süresi, işlem sayısı bölü tepe hızdır. İşlem sayısını süreye bölünce hız çıkar ve iki durum kalır. Taşıma uzun sürüyorsa hız, bant genişliği çarpı işlem yoğunluğudur — yoğunluk iki katına çıkınca hız da iki katına çıkar. Hesap uzun sürüyorsa hız, tepe hızın kendisidir ve yoğunluğu artırmak artık bir şey kazandırmaz. Kısaca:

`ulaşılabilir hız = en küçüğü(tepe hız, bant genişliği × işlem yoğunluğu)`

İki ekseni de logaritmik çizersen birinci terim yatay bir çizgi, ikincisi eğik bir doğru olur ve grafik bir çatıya benzer. İkisinin kesiştiği yere **sırt noktası** deniyor: tepe hıza ulaşmak için gereken en küçük işlem yoğunluğu, yani tepe hız bölü bant genişliği. 26\. makaledeki çipte bu, saniyede 275 trilyon işlemin saniyede 1,2 trilyon bayta bölümü: yaklaşık 229.

![Çatı çizgisi grafiği, iki eksen logaritmik. Yatay eksen işlem yoğunluğu, yani ana bellekten okunan bayt başına işlem; işaretler 1, 10, 100 ve 1000. Dikey eksen ulaşılabilir hız, saniyede trilyon işlem. Sol alttan yükselen eğik doğru bellek sınırıdır: hız eşittir 1,2 çarpı yoğunluk. Yoğunluk 229'da doğru, saniyede 275 trilyon işlemlik yatay işlem tavanına ulaşır; kesişme sırt noktası olarak işaretli. Eğik doğru üzerinde iki nokta: cihazda üretim, yığın 1, hız 1,2; bulutta üretim, yığın 32, hız 38,4. Tavanın üzerinde üçüncü nokta: 2.000 token'lık bir istemin ön dolumu, hız 275. Altta kayıt: noktalar çipin iki katalog sayısından hesaplanmıştır, ölçüm değildir.](assets/cati-cizgisi-ve-iki-asama.svg "Şekil 1 — Aynı çipte üç ayrı konum: yoğunluk hızı belirliyor")

Şekil 1 bu düzlemi ve seride kurduğumuz üç durumu aynı çipin sayılarıyla bir arada gösteriyor. Bir hesabın nerede durduğu, hangi eniyilemenin işe yarayacağını da söyler: sol tarafta işlem sayısını azaltmanın faydası yoktur, çünkü çip zaten beklemektedir; yapılacak şey ya taşınan baytı azaltmak ya da okunan her bayta daha çok iş düşürmektir.
...
Aynı hesabı bizim örneğimizde de yapabiliriz. 26\. makalede adım adım üretimin muhasebesini çıkarmıştık: ağırlıklar 16 bitteyse token başına 2N bayt okunur ve yığındaki her istek için yaklaşık 2N işlem yapılır, dolayısıyla işlem yoğunluğu tam olarak yığın büyüklüğüne eşittir. Sırt noktası 229 olan bir çipte bunun anlamı tek bir sayı: o çipin tepe hızına ulaşmak için yığında **229 istek** olması gerekir. Formüle koyalım; hesap bizim, girdiler yukarıdaki iki katalog sayısı. Yığın 1 ise hız `1,2 × 1 = 1,2` trilyon işlem, yani tepenin iki yüz yirmi dokuzda biri. Yığın 32 ise `1,2 × 32 ≈ 38,4` trilyon, yani yaklaşık yedide biri. Ön dolum ise başka bir yerde durur: ağırlıklar bir kez okunur ve istemin her token'ı için işlem yapılır, dolayısıyla 2.000 token'lık bir istemde yoğunluk kabaca 2.000'dir, sırt noktasının çok sağındadır ve hız tavana, 275'e dayanır. 26\. makalede ön dolumun hesaba, üretimin bellek bant genişliğine takıldığını görmüştük; Şekil 1'de o ayrım, iki noktanın sırt noktasının iki yanında durmasıdır. 28\. makaledeki bütün çizelgeleme mühendisliğinin tek amacı, üretimdeki yığını sırt noktasına yaklaştırmaktı.
...
Bunun çatı çizgisindeki anlamı doğrudan hesaplanabilir. Sırt noktası tepe hız bölü bant genişliği olduğuna göre, pay 60.000 kat, payda 100 kat büyüdüyse sırt noktası yirmi yılda yaklaşık 600 kat sağa kaymıştır — bu bizim hesabımız, girdileri yukarıdaki iki sayı. Yani aynı yoğunluktaki bir hesap, her yeni çip kuşağında mutlak olarak hızlansa da tepe hızın giderek daha küçük bir kesrini kullanır. Şekil 2 üç eğriyi logaritmik eksende çiziyor: üçü de düz doğru, ama aralarındaki açı yıllar geçtikçe açılıyor.

![Logaritmik dikey eksenli bir büyüme grafiği. Yatay eksen yıl, 0'dan 20'ye; dikey eksen başlangıca göre büyüme katı, 1'den 100.000'e. Üç doğru aynı noktadan başlar: donanımın tepe işlem kapasitesi yirmi yılda 60.000 kata, DRAM bant genişliği 100 kata, kartlar arası iletişim bandı 30 kata çıkar. Hesap ile bellek bandı doğruları arasındaki dikey aralık yirminci yılda 600 kattır ve sırt noktasının bu kadar sağa kaydığını gösterir. Altta kayıt: uç noktalar kaynaktan, aradaki doğrular sabit hızlı üstel büyüme varsayımıdır; 600 sayısı 60.000 bölü 100, kendi hesabımız.](assets/uc-iraksayan-ustel.svg "Şekil 2 — Hepsi büyüdü, ama farklı hızlarda: aradaki açı sırt noktasını sağa itiyor")

Aynı çalışmanın iki ölçümü tabloyu modele bağlıyor. Büyük Transformer modellerinin parametre sayısı 2018–2022 aralığında iki yılda 410 kat büyürken, tek bir hızlandırıcının belleği iki yılda yalnızca 2 kat büyüdü. Eğitim için gereken hesap ise iki yılda 750 kat arttı. Model, ona hizmet eden çipin belleğinden hızlı büyüdükçe iş birden çok karta bölünmek zorunda kalır ve yükün bir kısmı en yavaş büyüyen eğriye, kartlar arası banda biner.

Bu ayrışma, serinin bu bölümünde ayrı ayrı gördüğümüz şeylerin ortak kaynağı. 26\. makaledeki "adım adım üretim bellek bant genişliğiyle sınırlıdır", 27\. makaledeki bellek duvarı, 85\. makaledeki hepsi-hepsiye iletişim maliyeti, 86\. makaledeki "işlem sayısını azaltmak duvar saatini azaltmıyor" uyarısı ve 88\. makaledeki cihaz bütçesi — hepsi aynı üç eğrinin ayrışmasının farklı yerlerdeki görünüşü.
...
Tek çipin hesabı ve belleği iki eksendi. Ölçek büyüdüğünde üçüncüsü bağlayıcı hâle geliyor: kartlar arasındaki bağ. Şekil 2'de en yavaş büyüyen doğru oydu.
...
Bu ikinci sayının yanındaki kayıt daha öğretici: kart başına elde edilen verim, çipin teorik tepe hızının **yüzde 52'si**. Yani alanın en iyi mühendisliğe sahip eğitim koşularında bile tepe hızın yaklaşık yarısı kullanılamıyor. Kaybın tek bir adresi yok — çalışma aşağıdaki kalemleri ayrı ayrı tartışıyor ama açığı aralarında sayıyla paylaştırmıyor: kartlar arası iletişimi beklemek, boru hattı biçiminde bölünmüş modelde bazı kartların sırasını beklerken boşta kalması, ve büyük matris çarpımlarının yanındaki bellek sınırlı küçük işlemler. Büyük yığınlı eğitimin matris çarpımları sırt noktasının sağındadır; kayıp çoğunlukla onların arasında ve etrafında, yani Şekil 1'in tek bir çipi anlatan düzleminin göremediği yerlerde oluşur.
