...
tags:
  ...
  - melez-mimariler
  - karesel-maliyet
content_hash: sha256:da474a2065a9f20fd6c9691170c6869d9cdf6417c951068dcd7347368ba23623
...
**Durum uzayı modellerinin iki görünüşü vardır.** Eğitimde evrişim olarak paralel çalışır, çıkarımda yineleme olarak sabit maliyetlidir; seçicilik eklendiğinde evrişim görünüşü kaybolur ve yerine donanıma göre yazılmış bir tarama geçer.

**Sabit durum, geri çağırmayla ödenir.** Rehber yetmiş kaydı geçtiğinde 410 milyon parametreli bir Transformer 2,8 milyarlık bir durum uzayı modelini geçiyor; ölçülen perplexity boşluğunun yüzde 82'si çağrışımsal geri çağırmadan geliyor.
...
- Lieber, O., Lenz, B., Bata, H., Cohen, G., Osin, J., Dalmedigos, I., Safahi, E., Meirom, S., Belinkov, Y., Shalev-Shwartz, S., Abend, O., Alon, R., Asida, T., Bergman, A., Glozman, R., Gokhman, M., Manevich, A., Ratner, N., Rozen, N., Shwartz, E., Zusman, M. & Shoham, Y. (2025). *Jamba: Hybrid Transformer-Mamba Language Models*. ICLR 2025. Okunan sürüm, aynı çalışmanın ön baskısı olan arXiv:2403.19887'dir. [Bağlantı](https://proceedings.iclr.cc/paper_files/paper/2025/hash/a9ed43fa31dc8b4a7d7a673d713dcb5f-Abstract-Conference.html)
