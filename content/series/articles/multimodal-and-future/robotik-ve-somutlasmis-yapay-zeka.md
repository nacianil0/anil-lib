...
tags:
  ...
  - veri-kitligi
  - benzetim
content_hash: sha256:0eac6d93feecd644eb88cd4976780e3e8258652035acbce9583fd2b5f86a2410
classification_version: 1
classification_batch: 27
revised_at: "2026-09-26"
revision_note: "Ön eğitim ablasyonu tek değişkenli satır çiftine çekildi, 48,7 ve 47'ye karşı 0 ve 1; sınavın adı düzeltildi ve 91 puanlık sürümde mimarinin de değiştiği eklendi."
---
## Kavşaktan konuma
...
![Üç sütunlu tablo ve altında iki kutu; başlık: aynı soru, üç arayüz. Sütunlar metin ortamının şablonları, token olarak eylem ve sürekli eylem öbeği. Eylemin biçimi: dokuz komut şablonu, sekiz tam sayı, sürekli değerler. Çözünürlük: şablon içi ya da dışı, boyut başına 256 kutu, ayrıklaştırma yok. Karar sıklığı: adım adım metin turu, saniyede 1–3 ya da 5, saniyede 50'ye kadar. Arayüzün yasakladığı: şablon dışı her hareket, kutudan ince düzeltme, yok denecek kadar az. Birinci kutu: 256 kutu hareket aralığının 256'da birinden ince bir düzeltmeyi temsil edemez; saniyede 3 kararda iki karar arasında 333 milisaniye vardır. İkinci kutu, 47'nin dersi: biçim geçerliliği değeri zorlamaz. Altta kutu sayısı ve sıklıkların kaynaklardan geldiği, 333 milisaniyenin kendi hesabımız olduğu yazılıdır.](assets/uc-eylem-arayuzu.svg "Şekil 1 — Arayüz dünyanın değil, tasarımın özelliği")
...
İkinci ucuz kaynak başka gövdelerin verisi. O'Neill ve arkadaşlarının ortak kümesinin amacı tam buydu ve sonucu iki yönlü. Verisi az olan alanlarda kazanç açık: ortak veriyle eğitilen politika, laboratuvarların kendi yöntemlerinin ortalama başarısını yüzde elli oranında aşıyor. Verisi bol olan alanda ise aynı model **geriliyor**: tek bir robotun kendi verisiyle eğitilen sürüm 92 alırken, dokuz gövdelik robot karışımıyla eğitilen aynı mimari 73'e düşüyor. Yazarların tanısı kapasite: model karışımı taşıyamıyor ve yetersiz kalıyor. 55 milyar parametreli, görüntü-dil modeline dayanan ve web verisiyle birlikte eğitilen sürüme geçildiğinde puan 91'e dönüyor; bu adımda yalnızca boy değil mimari de değişiyor.
...
**Ön eğitimin katkısı bir ablasyonla kesindir.** Aynı model, aynı robot verisi, aynı geçmiş: ön eğitimliyken yüzde 48,7 ve 47, sıfırdan başlatıldığında yüzde 0 ve 1.
