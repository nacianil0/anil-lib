...
tags:
  ...
  - kumeleme
  - taban-cizgisi
content_hash: sha256:405874d16554054abe478e5ce3edc59c890e93180c041aec01db561df8e549bb
classification_version: 1
classification_batch: 23
revised_at: "2026-09-25"
revision_note: "Döndürme bulgusu, tek bölmenin merdivene dönüştüğünü gösteren yeni bir şekille açıklandı; üç bulgu metne taşındı, TabPFN sınırı düzeltildi."
---
...
İki gerçeği yan yana koymak öğretici. Problemin kendisi — noktaların merkezlerine olan karesel uzaklıklar toplamını en küçültmek — iki kümede bile NP-zordur; Lloyd'un yordamı ise yalnızca yerel bir çözüm bulur ve başlangıca göre çok kötü sonuçlar verebilir. David Arthur ve Sergei Vassilvitskii'nin SODA 2007'de sunduğu k-ortalamalar++ yalnızca **başlangıcı** değiştiriyor: merkezler rastgele değil, mevcut merkezlere uzaklığın karesiyle orantılı olasılıkla seçiliyor. Bu tek değişiklik, hiçbir güvence vermeyen yordamı, beklenen değerde en iyi kümelemenin logaritma k mertebesinde bir katı içinde kalması güvenceli bir yordama çeviriyor.
...
Üç bulgu çıktı. Birincisi düzgünlükle ilgili: hedef bir çekirdek düzleştiriciyle yumuşatıldığında ağaçların doğruluğu belirgin biçimde düşüyor, sinir ağlarınınki neredeyse etkilenmiyor. Yani bu kümelerdeki hedefler düzgün değil ve sinir ağlarının düzgün fonksiyonlara yatkınlığı burada bir dezavantaj. İkincisi boş özniteliklerle ilgili: özniteliklerin yarısına kadarı önem sırasına göre atıldığında gradyan artırmanın doğruluğu pek düşmüyor, sinir ağları ise bu atmadan fayda görüyor; bilgi taşımayan sütunlar sinir ağlarını daha çok yoruyor. Üçüncüsü döndürmeyle ilgili ve meselenin özü o.

Bir öğrenme yordamı **döndürmeye göre değişmez** ise, özniteliklere bir döndürme uygulanıp aynı eğitim tekrarlandığında sonuç değişmez. Çok katmanlı ağlar bu anlamda döndürmeye göre değişmezdir; ağaçlar değildir, çünkü her bölme tek bir özniteliğe bakar. Yazarlar veriyi rastgele döndürdüklerinde sıralama tersine dönüyor: sinir ağları öne geçiyor.

![İki panelli şekil; iki panelde de aynı kurgusal noktalar vardır, dolu daireler bir sınıf, içi boş daireler öbür sınıf. Sol panelde iki sınıfı dikey bir çizgi ayırır: tek bir özniteliğe konan tek bir eşik, yani ağaç için tek bölme. Sağ panelde aynı noktalar 45 derece döndürülmüştür; sınır artık köşegen bir kesikli çizgidir ve eksene paralel bölmeler onu ancak beş basamaklı bir merdivenle yaklaşık izleyebilir, her basamak ayrı bir bölme. Altta kayıtlar: döndürmeye göre değişmeyen bir ağ için iki panel aynı problemdir, ağaç için değildir; noktalar kurgusaldır ve ölçümü değil bulgunun mekanizmasını gösterir.](assets/uc-bulgu-ve-donme.svg "Şekil 3 — Döndürme, tek bölmeyi merdivene çevirir")

Şekil 3 bunun mekanizmasını kurgusal bir örnekle çiziyor. Solda iki sınıf tek bir özniteliğin eşiğiyle ayrılıyor; ağaç için bu tek bir bölmedir. Sağda aynı veri 45 derece döndürülmüş: sınır artık köşegen ve eksene paralel bölmelerle ancak basamak basamak izlenebiliyor. Her basamak ayrı bir bölme ister ve her bölme eldeki verinin daha küçük bir parçasına bakar; sonlu veride merdiven hem kaba hem oynak olur. Döndürmeye göre değişmeyen bir ağ için iki panel arasında hiçbir fark yok.
...
McElfresh ve arkadaşlarının not ettiği bir istisna daha var. Noah Hollmann ve arkadaşlarının ICLR 2023'te sunduğu TabPFN, bir transformer'ı sentetik veri üzerinde bir kez eğitip, yeni bir küçük tablo kümesini **isteme koyarak** — 23\. makaledeki örnekle öğrenmenin ta kendisi — tek ileri geçişte sonuç üretiyor. Özgün çalışma yöntemi bin eğitim satırına kadar olan kümelerde sınamıştı ve yöntem fiilen üç bin satırlık bir eğitim kümesiyle sınırlı; McElfresh'in taramasında büyük kümelerden rastgele üç bin satır verildiğinde bile ortalamada bütün diğer algoritmaları geçiyor. Ekibin Nature'da 2025'te yayımladığı sürüm aynı fikri genişletiyor. Dikkat edilecek yer şu: TabPFN'in üstünlüğü mimarisinin gücünden çok, **hangi varsayımı taşıdığından** geliyor — sentetik eğitim verisi basit nedensel yapılara doğru eğimli üretiliyor ve model o eğimi öğreniyor. Yine varsayım, yine kimlik.
