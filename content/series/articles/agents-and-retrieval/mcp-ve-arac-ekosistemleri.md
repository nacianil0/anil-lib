...
tags:
  ...
  - arac-getirme
  - arac-zehirleme
content_hash: sha256:f36e0b56a62752af7bb7388ba921406b8a6fae63b69abc66ab2eea0ea9484c5f
...
MCP, Kasım 2024'te yayımlanmış açık bir belirtim. Bu makalenin yazıldığı Eylül 2026'da beş sürümü var ve makale Temmuz 2026 tarihli güncel sürümü esas alıyor; protokol hızla değiştiği için aşağıdaki ayrıntıların bir kısmı sonraki sürümlerde değişmiş olabilir, değişmesi beklenmeyen kısım mimarinin mantığıdır. Belirtim resmî belgelendirmedir, hakemli bir çalışma değil; ne söylediğini olduğu gibi aktarıyoruz, ne kadar işe yaradığını ölçen çalışmalar sonraki bölümlerde.

Sürümlerin tarihleri protokolün hızını gösteriyor: Kasım 2024, Mart 2025, Haziran 2025, Kasım 2025 ve Temmuz 2026. Sürüm adı bir tarihtir ve geriye dönük uyumsuz bir değişikliğin yapıldığı son günü gösterir; uyumlu eklemeler sürüm adını değiştirmez. Bir özelliğin kaldırılması için de, belirtimin tanımladığı hızlandırılmış istisna dışında, en az on iki aylık bir kullanımdan kaldırma penceresi var.
...
Güncel sürümün iki kararı, serinin önceki makalelerine doğrudan bağlanıyor. Birincisi, protokol durumsuz hâle getirildi: her istek kendi protokol sürümünü ve istemcinin yeteneklerini taşıyor, açılış el sıkışması kaldırıldı — 21\. makaledeki durumsuz modelin protokol hâli; sunucu çağrılar arasında durum tutmak istiyorsa bunu açık bir tanıtıcıyla, sıradan bir argüman olarak yapıyor. İkincisi küçük ama öğretici: belirtim, sunucuların araç listesini **belirlenimci bir sırayla** döndürmesini öneriyor — zorunlu değil, belirtimin diliyle güçlü bir tavsiye; gerekçe, 26 ve 28\. makalelerdeki önek paylaşımı. Araç tanımları istemin başında duruyor ve sıra her seferinde aynıysa önbellek tutuyor; sıra değişirse önek bozuluyor ve tanımlar her çağrıda yeniden hesaplanıyor. Bir protokol kararının nedeni, anahtar-değer önbelleğinin ekonomisi.
