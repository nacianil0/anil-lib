...
tags:
  ...
  - chebyshev
  - istatistik
content_hash: sha256:f8bfcb1aa09a9e3c9c6ccc362683f76dc85eb90416850f6511f51af27d33e389
...
Bu aynı zamanda 24'ün Monte Carlo/Las Vegas ayrımını tamamlıyor. Las Vegas algoritması hep doğru cevabı verir ve süresi bir rastgele değişkendir — sorulacak şey beklentisi ve yoğunlaşmasıdır. Monte Carlo algoritması sabit sürede biter ve **cevabı** bir rastgele değişkendir — sorulacak şey hata olasılığıdır ve tekrar ederek üstel olarak düşürülür.
...
- Cormen, T. H., Leiserson, C. E., Rivest, R. L. & Stein, C. *Introduction to Algorithms*, dördüncü baskı — bu makalenin algoritma tarafındaki ders kitabı karşılığı **5. bölüm (Probabilistic Analysis and Randomized Algorithms)** ile **9. bölüm (Medians and Order Statistics)**'tir; bölüm adları MIT Press'in resmî *Selected Solutions* belgesinin içindekiler tablosundan doğrulanmıştır. Alt bölüm başlıkları bu belgeden doğrulanamadığı için atıf **bölüm düzeyindedir**. MIT Press, 2022. [Bağlantı](https://mitpress.mit.edu/9780262046305/introduction-to-algorithms/)
