...
tags:
  ...
  - aralik-cizelgeleme
  - karsi-ornek
content_hash: sha256:e2f9b2b7b9b20fc1681134d194f9b6e53dc8187364107ac5a86e301abe6366b2
...
**Para üstü.** Verilen bir tutarı en az sayıda madenî parayla ödemek istiyoruz. Açgözlü kural "sığan en büyük parayı ver" olur ve tanıdık sistemlerde çalışır: 1, 5, 10, 25 ve 50 kuruşluk paralarla açgözlü seçimin 5.000 kuruşa kadar her tutarda optimal olduğunu kaba kuvvetle kendim denetledim; her tutar için açgözlünün verdiği para sayısını dinamik programlamayla bulunan en az sayıyla karşılaştırdım. Bu sonlu denetim her tutarı kapsar, çünkü Kozen ve Zaks açgözlüyü bozan bir tutar varsa en küçüğünün en büyük iki paranın toplamından, burada 50 + 25 = 75'ten küçük olduğunu ispatlamıştır. Açgözlünün her tutarda doğru çalıştığı böyle sistemlere **kanonik (canonical)** para sistemi denir. Ama bu, kuralın değil **sistemin** özelliğidir. Paralar 1, 3 ve 4 birim olsaydı 6 birim için açgözlü 4 + 1 + 1 verirdi — üç para; oysa 3 + 3 iki parayla ödüyor. Aynı kural, aynı algoritma, farklı girdi ailesi: kural artık yanlış.
...
![Solda bir Huffman ağacı, sağda kod tablosu. Kök 100'ün çocukları 40 ve 60; 40'ın yaprakları N · 15 ve E · 25; 60'ın çocukları 26 ve A · 34; 26'nın çocukları R · 12 ve 14; 14'ün yaprakları S · 5 ve I · 9. Sol dallar 0, sağ dallar 1. Tabloda kodlar A 11, E 01, N 00, R 100, I 1011, S 1010; bitler 68, 50, 30, 36, 36, 20, toplam 100 simge ve 240 bit. Sabit 3 bit/simge 300 bit eder, kazanç %20, ortalama 2,40 bit. Alttaki not: birleştirme sırası S + I, R + 14, N + E, 26 + A, 40 + 60; S ve I en derin seviyede kardeştir](assets/huffman-agaci.svg "Şekil 2 — Huffman ağacı: en seyrek iki simgeyi birleştirmek 300 biti 240 bite indiriyor")
...
- Kozen, D. & Zaks, S. *Optimal Bounds for the Change-Making Problem*, Theoretical Computer Science, cilt 123, sayı 2, 1994, s. 377–388 — kanonik para sisteminin tanımı (açgözlü her tutarda optimal) ve açgözlüyü bozan bir tutar varsa en küçüğünün c₃ + 1 < x < c_m + c_(m−1) aralığında olduğu sıkı sınır. [Bağlantı](https://doi.org/10.1016/0304-3975%2894%2990134-1)
