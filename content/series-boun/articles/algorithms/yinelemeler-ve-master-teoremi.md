...
revision_note: "Master Teoremi'nin CLRS 3. ve 4. baskılarındaki farkı ile düzenlilik koşulunun polinomlarda neden kendiliğinden sağlandığı eklendi."
---
...
Takip zinciri çoğu zaman üç halkadır: "Bu yinelemenin çözümü ne?" → "Teorem burada neden uygulanıyor, hangi koşulu sağlıyorsun?" → "Peki T(n) = T(n − 1) + n ya da T(n) = 2T(n/2) + n log n olsaydı?" Son halkada ya teoremin sustuğunu görüp açarak çözmeye dönersin ya da hangi sürümü kullandığını söyleyerek genişletilmiş durum 2'yi uygularsın.
...
- Cormen, T. H., Leiserson, C. E., Rivest, R. L. & Stein, C. *Introduction to Algorithms*, dördüncü baskı, 4. bölüm (Divide-and-Conquer — yerine koyma yöntemi, özyineleme ağaçları ve Master Teoremi; bu baskıda Teorem 4.1'in durum 2'si lgᵏ n çarpanına, k ≥ 0, izin verir). MIT Press, 2022. [Bağlantı](https://mitpress.mit.edu/9780262046305/introduction-to-algorithms/)
- Cormen, T. H., Leiserson, C. E., Rivest, R. L. & Stein, C. *Introduction to Algorithms*, üçüncü baskı, 4.5 (The master method for solving recurrences) — Teorem 4.1'in üç durumu (a ≥ 1, b > 1; durum 2 yalnızca f(n) = Θ(n^(log_b a)) için), üçüncü durumdaki a·f(n/b) ≤ c·f(n) düzenlilik koşulu ve "polinom olarak sınırlı fonksiyonların çoğunun" bunu sağladığı notu, durumlar arasındaki iki boşluk ve T(n) = 2T(n/2) + n lg n yinelemesine yöntemin uygulanmadığı örneği. MIT Press, 2009. [Bağlantı](https://mitpress.mit.edu/9780262033848/introduction-to-algorithms/)
