...
tags:
  ...
  - bellman-ford
  - azalt-anahtar
content_hash: sha256:dba791bbec1fff7e103aa61c94489874251413dc4f435506c1df50349fa24515
...
![Aynı grafı dikey bir çizgiyle ayrılmış iki panelde gösteren şema. Beş düğüm ve yedi kenar iki panelde aynı: A–B 4, A–C 3, A–E 7, B–C 2, B–D 5, C–E 6, D–E 1. Sol panel minimum kapsayan ağaç, toplam 11: A–C, B–C, B–D ve D–E kalın, kalan üç kenar ince; altında seçilen kenarlar yazıyor. Sağ panel en kısa yollar ağacı, kaynak A vurgulu, kenar toplamı 15: A–B, A–C, A–E ve D–E kalın; altında A'ya uzaklıklar A 0, C 3, B 4, E 7, D 8. Alttaki not: aynı graf, iki farklı ağaç; MST toplamı, en kısa yollar ağacı her düğüme uzaklığı en küçük yapar](assets/mst-ile-en-kisa-yollar-agaci.svg "Şekil 1 — Aynı graf, iki farklı soru, iki farklı ağaç")
