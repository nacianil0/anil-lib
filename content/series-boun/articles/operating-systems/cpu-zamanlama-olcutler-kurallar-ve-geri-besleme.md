...
content_hash: sha256:565dcf46cd11abf69f4477256b8dc4e7f06263a4d82a3a0ba6c36e4a6ab3b4c7
...
![İki panelli zaman çizelgesi. Solda dönüş süresi ölçütü: A t=0'da gelir ve 100 birim sürer, B ve C t=10'da gelir ve 10'ar birim sürer. FCFS ve SJF aynı çizelgeyi üretir: ortalama dönüş süresi 103,3. Önkesmeli STCF'de A'nın kısa bir parçasını B ve C izler, sonra A'nın kalanı gelir: ortalama dönüş süresi 50. Sağda tepki süresi ölçütü: A, B ve C t=0'da gelir, her biri 5 birim. SJF üç eşit blokla ortalama tepki 5, ortalama dönüş 10 verir. Dilimi 1 birim olan round-robin 15 bloğu A B C diye döndürür: ortalama tepki 1, ortalama dönüş 14. Alt satır: tepki süresini 5'ten 1'e indiren kural, dönüş süresini 10'dan 14'e çıkarır](assets/zamanlama-gantt.svg "Şekil 1 — Aynı işler, farklı kurallar: bir ölçütte kazanan kural ötekinde kaybeder")
...
Dördüncü ve beşinci kurallar birer yamadır ve ikisi de karşı örnekle doğmuştur. Dördüncü kural işleri aşağı indirdiği hâlde beşinci kural yoksa uzun işler **açlığa (starvation)** düşer: alt kuyruğa inmiş bir uzun iş, üst kuyruklarda yeterince çok etkileşimli iş varsa işlemciyi hiç göremez. (Yalnızca ilk üç kural olsaydı kimse aşağı inmezdi ve herkes en üst kuyrukta round-robin ile dönerdi.) Beşinci kural bunu çözer ve ikinci bir fayda daha getirir — davranışı değişen, yani hesap ağırlıklıyken etkileşimliye dönen bir iş yeniden yukarı taşınır. Dördüncü kuralın önceki hâli ise işlemciyi tahsisi bitmeden gönüllü bırakan işi cezalandırmıyordu; bunu fark eden bir program tahsisinin %99'unu kullanıp gereksiz bir giriş/çıkış yaparak önceliğini sonsuza kadar koruyabilir, yani **çizelgeleyiciyi oynatabilirdi**. Muhasebeyi düzeyde biriktirmek — "nasıl harcadığın değil, ne kadar harcadığın önemli" — bu açığı kapatır.
...
![İki panelli şema. Solda çok seviyeli geri besleme kuyruğunun beş kuralı, 3 ve 4 vurgulu: 1 önceliği yüksek olan çalışır; 2 öncelikler eşitse round-robin; 3 yeni iş en üst kuyruğa girer, iyimser varsayım: kısa iş olabilir; 4 tahsis tükenince bir alt kuyruğa iner, kaç kez bıraktığı önemsizdir; 5 S süresinde bir herkes en üste taşınır, açlığı bu kural engeller. Sağda işlerin kuyruklar arasındaki yolculuğu: Q2 yüksek 10 ms, Q1 orta 20 ms, Q0 düşük 40 ms. Koyu iz uzun iştir, tahsisini bitirdikçe Q2'den Q0'a iner; soluk iz etkileşimli iştir, üstte kalır. Kesik çizgi S anıdır, soluk bir ok Q0'dan en üste çıkar. Alt not: dördüncü ve beşinci kural yamadır, ikisi de karşı örnekle doğdu](assets/mlfq-kurallar.svg "Şekil 2 — Kâhinlik yerine geri besleme: iş kendini davranışıyla ele verir")
