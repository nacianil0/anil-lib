...
tags:
  ...
  - kosul-degiskeni
  - test-and-set
content_hash: sha256:019e1817b3751d335176dd21caa83428574f86a2804a4046fb8de8dd18b50c4f
...
Problemi ilk kez formüle eden Dijkstra, 1965 tarihli ders notlarında çözümün sağlaması gerekenleri üç maddeye bağladı ve bu üçlü hâlâ standarttır.

**Karşılıklı dışlama (mutual exclusion).** Herhangi bir anda süreçlerden **en fazla biri** kritik kesiminde olabilir. Bu, "kötü bir şey olmasın" türünden bir koşuldur.

**İlerleme (progress).** Kritik kesiminin **iyice dışında** duran bir süreci durdurmak, ötekilerin özgürlüğünü hiçbir biçimde kısıtlamamalıdır. Yani kritik kesime girmek isteyen kimse yokken bekleyen birinin bekletilmesi yasaktır.

**Sınırlı bekleme (bounded waiting).** Birden fazla süreç kritik kesime girmek üzereyse, hangisinin önce gireceği kararı **sonsuza ertelenemez** — süreçlere hangi sonlu hızları verirsen ver. Bu koşul, hız varsayımı yapmayı da yasaklar: çözüm, süreçlerin göreli hızları hakkında hiçbir şey varsaymamalıdır.
...
Kilit değişkeninin kendisi yalnızca bir durum tutar: boş ya da tutulmuş. İçine sahibin kimliği veya bekleyenlerin kuyruğu da konabilir, ama bunlar kullanıcıdan gizlenir — veri yapıları makalesindeki arayüz ile temsil ayrımının aynısı.
...
Kötü niyetli çizelgeleyici bunu ikinci hamlede kırar. İş parçacığı 1 bayrağı okur ve 0 görür; tam bayrağı yazmadan kesilir. İş parçacığı 2 çalışır, bayrağı okur ve **yine 0 görür**, bayrağı 1 yapar ve kritik kesime girer. Denetim 1'e döndüğünde onun elinde hâlâ "boştu" bilgisi vardır: bayrağı 1 yapar ve **o da girer**. Karşılıklı dışlama daha ilk koşulda düşmüştür.

Bunu göz kararıyla bırakmadım: iki iş parçacığının bütün yürütme sıralarını kaba kuvvetle taradığım küçük bir program yazdım. Bayrak çözümünde erişilebilir **57 durumun** içinde ikisinin de kritik kesimde olduğu bir durum var; birazdan kuracağımız test-and-set kilidinde erişilebilir **5 durumun** hiçbirinde yok. Bu sayılar bana ait, kaynaktan alınmadı.
...
![Dikey bir çizgiyle ayrılmış iki panelli bir şema. Sol panelin başlığı yükle sakla ile kurulan bayrağın çöküşü. Panelde üç sütunlu bir iz tablosu var; sütun başlıkları adım, iş parçacığı bir ve iş parçacığı iki. Satırlar sırayla şunları gösteriyor: birinci adımda iş parçacığı bir bayrağı okur ve sıfır görür, ikinci sütun boştur. İkinci adımda ikinci sütun boş kalır ve üçüncü sütunda iş parçacığı iki bayrağı okur, o da sıfır görür. Üçüncü adımda iş parçacığı bir bayrağı bir yapar. Dördüncü adımda iş parçacığı bir kritik kesime girer ve aynı satırda iş parçacığı iki bayrağı bir yapar. Beşinci adımda iş parçacığı iki de kritik kesime girer; bu son satırdaki iki hücre de vurgulanmıştır. Tablonun altında bir not: ikisi de içeride, karşılıklı dışlama yok. Sağ panelin başlığı merdiven, her basamak ne ekliyor. Panelde alt alta dört blok var. Birinci blokta kesmeleri kapatmak yazıyor; altında tek işlemcide çalışır, çok işlemcide çalışmaz, ayrıcalık ister notu var. İkinci blokta bayrak, yani sıradan okuma ve yazma yazıyor; altında karşılıklı dışlamayı bile veremez notu var. Üçüncü blok vurgulanmış; içinde test and set, yani oku ve yaz tek adımda yazıyor; altında karşılıklı dışlama var ama adalet yok notu var. Dördüncü blokta sıra kilidi, yani getir ve ekle yazıyor; altında herkese sıra numarası verir, sınırlı bekleme de sağlanır notu var. Panelin altında iki satır: üç koşul karşılıklı dışlama, ilerleme ve sınırlı beklemedir; kritik kesiminin dışında duran bir süreç ötekilerin özgürlüğünü kısıtlamamalıdır. En altta bir not: iki kilidin bütün yürütme sıraları kaba kuvvetle tarandı, bayrak çözümünde elli yedi durumun içinde ihlal var, test and set kilidinde beş durumun hiçbirinde yok](assets/kilit-merdiveni.svg "Şekil 1 — Sıradan okuma ve yazma yetmez; eksik olan tek şey bölünmezliktir")
...
Son bir tuzak, kilidin kendisinden değil çizelgeleyiciyle etkileşiminden doğar. Düşük öncelikli bir iş parçacığı kilidi alsın; yüksek öncelikli bir iş parçacığı aynı kilidi isteyip dönmeye başlasın. Çizelgeleyici her zaman yüksek önceliği seçtiği için düşük öncelikli olan hiç çalışamaz ve kilidi bırakamaz; sistem donar. Adı **öncelik tersine dönmesidir (priority inversion)** ve 1997'de Mars Pathfinder aracında gerçekten yaşanmıştır. Standart çözümü **öncelik kalıtımıdır (priority inheritance)**: kilidi bekleyen yüksek öncelikli iş parçacığı, kendi önceliğini kilidi tutana geçici olarak ödünç verir.

![Dikey bir çizgiyle ayrılmış iki panelli bir şema. Sol panelin başlığı kilidi bekleyen ne yapmalı. Panelde alt alta üç seçenek bloğu var. Birinci blokta dön yazıyor; altında iki not satırı var: sistem çağrısı yok, çekirdek desteği gerekmez; tek işlemcide en kötü durumda N eksi bir zaman dilimi boşa gider. İkinci blokta işlemciyi bırak yazıyor; altında iki not var: dönmek yerine kendini çizelgeden çıkarırsın; yüz iş parçacığı için doksan dokuz bağlam anahtarı ödenir. Üçüncü blok vurgulanmış; içinde kuyrukta uyu yazıyor; altında üç not var: kilit kendi bekleyen kuyruğunu tutar; bırakan doğrudan sıradakini uyandırır; israf da açlık da biter ama işletim sistemi desteği gerekir. Blokların altında bir satır: gerçek kilitler ikisini birleştirir, önce kısa süre döner sonra uyur. Sağ panelin başlığı semafor, tek sayaç ve iki işlem. Panelin üstünde iki tanım kutusu var; birincide V işlemi sayacı bölünmez biçimde bir artırır, bekleyen varsa birini uyandırır yazıyor; ikincide P işlemi sonuç negatif olmayacaksa sayacı bir azaltır, olmayacaksa bekler yazıyor. Altında üç kullanım satırı var: başlangıç değeri bir ise kilit olur, aynı anda tek bir süreç girer; başlangıç değeri sıfır ise sıralama aracı olur, biri bitirmeden öteki devam edemez; başlangıç değeri N ise en fazla N sürecin girebildiği bir kaynak havuzu olur. En altta bir not: sayaç negatifse mutlak değeri bekleyen süreç sayısıdır](assets/bekleme-ve-semafor.svg "Şekil 2 — Bekleyenin üç seçeneği ve aynı sayacın üç farklı işi")
...
**V işlemi**, argüman semaforun değerini bir artırır ve bu artış bölünmez sayılır. Sıradan bir `S := S + 1` neden yetmez? Çünkü iki süreç aynı anda okuyup aynı değeri yazabilir ve artışlardan biri kaybolur — süreçler makalesindeki sayaç örneğinin ta kendisi. **P işlemi**, sonuç negatif olmayacaksa değeri bir azaltır; olmayacaksa azaltma yapılmaz ve çağıran bekler. Gecikmeyi taşıyan işlem P'dir: değeri sıfır olan bir semafor üzerinde P çağıran süreç, bir başkası aynı semafora V yapana kadar devam edemez. Modern isimleri `sem_wait` ve `sem_post`'tur; bekletme yönünü hatırlamak için "aşağı" ve "yukarı" da denir. Değeri negatif tutan gerçekleştirimlerde faydalı bir değişmez vardır: **negatif değerin mutlak değeri, bekleyen süreç sayısıdır.**
...
Kilit ile koşul değişkenlerinin bir arada paketlenmiş hâline **monitör (monitor)** denir: veri, onu koruyan kilit ve o veriyle ilgili beklemeleri taşıyan koşul değişkenleri tek bir yapıda durur. Java'nın `synchronized` bloğu ve `wait`/`notify` çifti bu fikrin doğrudan uygulamasıdır.
...
- Silberschatz, A., Galvin, P. B. & Gagne, G. *Operating System Concepts*, onuncu baskı — bu makalenin kapsamının ders kitabı karşılığı **Chapter 6 Synchronization Tools**'tur; ilgili alt bölümler resmî içindekiler tablosundan doğrulanmıştır: 6.1 Background, 6.2 The Critical-Section Problem, 6.3 Peterson's Solution, 6.4 Hardware Support for Synchronization, 6.5 Mutex Locks, 6.6 Semaphores, 6.7 Monitors, 6.8 Liveness, 6.9 Evaluation. John Wiley & Sons. [Bağlantı](https://www.os-book.com/OS10/index.html)
